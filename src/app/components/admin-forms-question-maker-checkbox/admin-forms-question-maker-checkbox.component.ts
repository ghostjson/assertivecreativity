...
@Component({
  selector: 'app-admin-forms-question-maker-checkbox',
  templateUrl: './admin-forms-question-maker-checkbox.component.html',
  styleUrls: ['./admin-forms-question-maker-checkbox.component.scss']
})
export class AdminFormsQuestionMakerCheckboxComponent implements OnInit {
