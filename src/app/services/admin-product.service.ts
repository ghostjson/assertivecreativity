...
import {
  ActiveProductState,
  AdminProductServiceState,
} from '../models/AdminProductServiceState';
...
export class AdminProductService extends StateService<AdminProductServiceState> {
   ...
   *
   *
   * ************************* STATE MANAGEMENT FUNCTIONS STARTS ***************************
   *
   *
   */

  /**
   * get the active product that is being currently edited/created
   * @returns the currently active attribute that is being edited
   */
  getActiveProduct(): Observable<ActiveProductState> {
  ...
  /**
   * set the active product being edited/created
   * @param state active product
   */
  setActiveProduct(state: ActiveProductState): void {
    this.setState({
      activeProduct: state,
    });
  }
   ...
   *
   *
   * ************************* STATE MANAGEMENT FUNCTIONS ENDS ***************************
   *
   *
   */
